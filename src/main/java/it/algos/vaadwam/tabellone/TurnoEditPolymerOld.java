...
@Slf4j
public class TurnoEditPolymerOld extends PolymerTemplate<TurnoEditModel> implements HasUrlParameter<String> {
     ...
     */
    public TurnoEditPolymerOld(ITabellone tabellone, Dialog dialogo, Turno turno, boolean nuovoTurno) {
