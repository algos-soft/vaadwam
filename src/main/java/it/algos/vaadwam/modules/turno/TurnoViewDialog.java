...
import it.algos.vaadwam.modules.iscrizione.IscrizioneViewDialog;
...
public class TurnoViewDialog extends AViewDialog<Turno> {
     ...
     */
    @Autowired
    public TurnoViewDialog(@Qualifier(TAG_TUR) IAPresenter presenter) {
        super(presenter);
