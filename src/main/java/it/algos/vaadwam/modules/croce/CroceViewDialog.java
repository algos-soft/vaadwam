...
public class CroceViewDialog extends WamViewDialog<Croce> {
    ...
    protected PersonPresenter personPresenter;

    protected PersonService personService;

    protected PersonViewDialog presidenteDialog;
     ...
     */
    @Autowired
    public CroceViewDialog(@Qualifier(TAG_CRO) IAPresenter presenter) {
        super(presenter);
