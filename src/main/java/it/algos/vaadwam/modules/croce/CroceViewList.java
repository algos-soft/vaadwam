...
import it.algos.vaadwam.modules.funzione.FunzioneViewDialog;
 ...
 */
@UIScope
@Route(value = TAG_CRO, layout = MainLayout.class)
@Qualifier(TAG_CRO)
@AIView(menuName = "funzioni", roleTypeVisibility = EARoleType.admin)
@Slf4j
@AIScript(sovrascrivibile = false)
public class CroceViewList extends WamViewList {
     ...
     */
    @Autowired
    public CroceViewList(@Qualifier(TAG_CRO) IAPresenter presenter, @Qualifier(TAG_CRO) IADialog dialog) {
        super(presenter, dialog);
        ((CroceViewDialog) dialog).fixFunzioniWam(this::save, this::delete);
