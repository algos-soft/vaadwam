 ...
 */
@UIScope
@Route(value = TAG_FUN, layout = MainLayout.class)
@Qualifier(TAG_FUN)
@AIView(menuName = "funzioni", roleTypeVisibility = EARoleType.user)
@Slf4j
@AIScript(sovrascrivibile = false)
public class FunzioneViewList extends WamViewList {
...
//    public static final String MENU_NAME = "funzioni";
     ...
     */
    @Autowired
    public FunzioneViewList(@Qualifier(TAG_FUN) IAPresenter presenter, @Qualifier(TAG_FUN) IADialog dialog) {
        super(presenter, dialog);
        ((FunzioneViewDialog) dialog).fixFunzioniWam(this::save, this::delete);
