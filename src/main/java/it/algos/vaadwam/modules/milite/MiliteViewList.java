 ...
 */
@UIScope
@Route(value = TAG_MIL, layout = MainLayout.class)
@Qualifier(TAG_MIL)
@AIView(menuName = "militi", roleTypeVisibility = EARoleType.user)
@Slf4j
@AIScript(sovrascrivibile = false)
public class MiliteViewList extends WamViewList {
     ...
     */
    @Autowired
    public MiliteViewList(@Qualifier(TAG_MIL) IAPresenter presenter, @Qualifier(TAG_MIL) IADialog dialog) {
        super(presenter, dialog);
        ((MiliteViewDialog) dialog).fixFunzioniWam(this::save, this::delete);
