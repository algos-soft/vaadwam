 ...
 */
@UIScope
@Route(value = TAG_SER, layout = MainLayout.class)
@Qualifier(TAG_SER)
@AIView(menuName = "servizi", roleTypeVisibility = EARoleType.user)
@Slf4j
@AIScript(sovrascrivibile = false)
public class ServizioViewList extends WamViewList {
     ...
     */
    @Autowired
    public ServizioViewList(@Qualifier(TAG_SER) IAPresenter presenter, @Qualifier(TAG_SER) IADialog dialog) {
        super(presenter, dialog);
        ((ServizioViewDialog) dialog).fixFunzioniWam(this::save, this::delete);
